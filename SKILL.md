...
9. **Draft.** Read [references/article.md](references/article.md) to turn the approved outline into the canonical prose article without leaking planning labels. Complete when the article preserves the governing premise, selected route, proof assignments, deliberate gaps, and truth boundary.
10. **Slopless.** Read [references/slopless.md](references/slopless.md) before substantive English drafting for preflight and again after drafting for deterministic hygiene. Complete on a clean result, a transparently reported deliberate exception, or an explained non-English skip.
