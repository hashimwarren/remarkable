...
Use this positioning: **Bring your own style. Remarkable strengthens the persuasion.** When comparing it with Impeccable, use: **Impeccable gives agents visual rhetoric. Remarkable gives agents verbal rhetoric.** Treat this release as `1.6.0`.
...
- Treat the approved outline as the rhetorical contract that later drafting and editing must preserve or consciously renegotiate.
...
- `draft`: verify approval through [references/outline.md](references/outline.md), preserve its contract through [references/rhetorical-contract.md](references/rhetorical-contract.md), draft through [references/article.md](references/article.md), and follow [references/slopless.md](references/slopless.md) for preflight and post-draft hygiene.
- `opening`: build or diagnose the reader contract with [references/opening.md](references/opening.md) and [references/rhetorical-contract.md](references/rhetorical-contract.md).
- `develop`: develop claims through proof and consequence with [references/develop.md](references/develop.md).
- `framework`: evaluate or develop an operational framework with [references/framework-design.md](references/framework-design.md) and preserve its role through [references/rhetorical-contract.md](references/rhetorical-contract.md).
- `proof` or `prove`: map, research, validate, or design evidence with [references/prove.md](references/prove.md), [references/evidence-design.md](references/evidence-design.md), and [references/rhetorical-contract.md](references/rhetorical-contract.md).
- `headline`: develop or diagnose a headline with [references/headline.md](references/headline.md) and [references/rhetorical-contract.md](references/rhetorical-contract.md).
- `closing` or `ending`: complete the premise and evaluate the CTA with [references/ending.md](references/ending.md) and [references/rhetorical-contract.md](references/rhetorical-contract.md).
- `critique`: diagnose a complete article against [references/rhetorical-contract.md](references/rhetorical-contract.md) and obtain revision authority through [references/critique.md](references/critique.md).
...
1. **Premise.** Read [references/premise.md](references/premise.md) to elicit audience and desired perception, establish the reader's awareness transition, present three materially different governing premises, and obtain explicit selection. It loads [references/premise-transformation.md](references/premise-transformation.md) because the private council, audience fit, awareness bridge, appeals, and distinctness tests belong there. Complete when one premise is explicitly selected and a fresh candidate intelligent objection is ready for pressure-testing.
...
5. **Article route.** Read [references/article-routes.md](references/article-routes.md) to consume the awareness transition already established during premise formation, advocate two distinct invisible architectures, and obtain a route choice. Read [references/narrative-tension.md](references/narrative-tension.md) only when shaping its question and resolution. Complete when one route is explicitly confirmed and a compact private route brief exists.
6. **Working outline.** Read [references/outline.md](references/outline.md) to reserve or reuse the article and outline paths, turn the route into a scan-friendly rhetorical contract, select the first working headline privately, and classify unresolved needs. Read [references/visual-placeholders.md](references/visual-placeholders.md) only when planning earned visual positions. Complete when the initial outline exists with `Status: working`; this is not approval.
...
9. **Draft.** Read [references/rhetorical-contract.md](references/rhetorical-contract.md), [references/article.md](references/article.md), and the required [references/slopless.md](references/slopless.md) preflight adapter before prose. Turn the approved outline into the canonical article without leaking planning labels. Complete when the article executes the approved rhetorical contract while preserving the premise, proof assignments, deliberate gaps, and truth boundary.
10. **Slopless.** After drafting, return to [references/slopless.md](references/slopless.md) for deterministic hygiene governed by the rhetorical contract. Complete when every finding is addressed or deliberately preserved, or on an explained non-English skip.
11. **Critique and review.** Read [references/critique.md](references/critique.md) to evaluate adherence and effectiveness, localize high-value interventions, and obtain revision authority before changing direction. Use [references/roughdraft-handoff.md](references/roughdraft-handoff.md) for every watched review. Complete when accepted edits are applied, Slopless is rerun after substantive revision, and the writer receives the ready-state handoff.
