...
Keep article-specific planning and evidence beside the draft. Do not turn project context into a scrapbook of one article's decisions.

Preview changes and obtain human approval before modifying an existing context file. `PRODUCT.md` may receive approved durable updates to users, product purpose, or anti-references. Never put article-specific rhetoric in `PRODUCT.md`, write rhetorical content to `DESIGN.md`, or create or overwrite `VOICE.md` or `STYLE.md`.
