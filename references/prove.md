...
For each claim record the source, what it supports, its confidence, any contradiction, and whether the wording must be narrowed. Separate verified fact, source-backed interpretation, inference, and uncertainty. Never invent statistics, quotations, customer outcomes, benchmarks, events, or causal relationships.
...
- **Claim:** [Consequential assertion]
  - **Needed:** [Proof capable of carrying it]
  - **Available:** [Verified source or writer-owned evidence, or none]
